<?php return array (
  ...
  array (
    ...
    array (
      'attributes' => 
      array (
        'title' => 'Estrutura do Administração',
      ),
    ...
    array (
      ...
      'value' => '<p>Um Fórum de suporte técnico e submissão de bugs do sistema pode ser acedido via <a href="http://forum.pkp.sfu.ca/" target="_blank">PKP</a>.</p>
		<p>Para perguntas sobre como interagir com uma revista eletrónica específica, que usa o sistema ou sobre a política de tal revista, devem entrar em contacto com o suporte listado em "Sobre" de cada revista.</p>',
    ),
  ),
); ?>