<?php /* Smarty version 2.6.26, created on 2016-11-22 15:37:15
         compiled from file:/var/www/repositorio/plugins/auth/ldap/settings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'file:/var/www/repositorio/plugins/auth/ldap/settings.tpl', 13, false),array('function', 'fieldLabel', 'file:/var/www/repositorio/plugins/auth/ldap/settings.tpl', 17, false),array('modifier', 'escape', 'file:/var/www/repositorio/plugins/auth/ldap/settings.tpl', 19, false),)), $this); ?>
<br />
<div id="ldapSettings">
...
<table class="data" width="100%">
	<tr valign="top">
		...
		<td width="80%" class="value">
			<input type="text" id="hostname" name="settings[hostname]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['settings']['hostname'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="30" maxlength="255" class="textField" />
	...
	<tr valign="top">
		...
		<td class="value">
			<input type="text" id="port" name="settings[port]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['settings']['port'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="8" maxlength="5" class="textField" />
	...
	<tr valign="top">
		...
		<td class="value">
			<input type="text" id="basedn" name="settings[basedn]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['settings']['basedn'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="30" maxlength="255" class="textField" />
			<br />
	...
	<tr valign="top">
		...
		<td class="value">
			<input type="text" id="managerdn" name="settings[managerdn]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['settings']['managerdn'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="30" maxlength="255" class="textField" />
			<br />
	...
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'uid','key' => "plugins.auth.ldap.settings.uid"), $this);?>
</td>
		<td class="value">
			<input type="text" id="uid" name="settings[uid]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['settings']['uid'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="30" maxlength="255" class="textField" />
			<br />
			<span class="instruct"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugins.auth.ldap.settings.uid.description"), $this);?>
</span>
		</td>
	</tr>
	<tr valign="top">
		...
		<td class="value">
			<input type="password" id="managerpwd" name="settings[managerpwd]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['settings']['managerpwd'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="30" maxlength="255" class="textField" />
			<br />
	...
	<tr valign="top">
		...
		<td class="value">
			<input type="text" id="saslmech" name="settings[saslmech]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['settings']['saslmech'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="30" maxlength="255" class="textField" />
			<br />
	...
	<tr valign="top">
		...
		<td class="value">
			<input type="text" id="saslrealm" name="settings[saslrealm]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['settings']['saslrealm'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="30" maxlength="255" class="textField" />
		</td>
	</tr>
	<tr valign="top">
		...
		<td class="value">
			<input type="text" id="saslauthzid" name="settings[saslauthzid]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['settings']['saslauthzid'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="30" maxlength="255" class="textField" />
		</td>
	</tr>
	<tr valign="top">
		...
		<td class="value">
			<input type="text" id="saslprop" name="settings[saslprop]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['settings']['saslprop'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="30" maxlength="255" class="textField" />
		</td>
	</tr>
</table>
