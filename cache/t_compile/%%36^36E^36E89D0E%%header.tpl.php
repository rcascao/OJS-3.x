<?php /* Smarty version 2.6.26, created on 2017-02-20 12:51:27
...
<?php if (! ( $this->_tpl_vars['pageTitleTranslated'] == "Revista Portuguesa de Investigação Comportamental e Social" || $this->_tpl_vars['pageTitleTranslated'] == 'Portuguese Journal of Behavioral and Social Research' )): ?>
	<h2><?php echo $this->_tpl_vars['pageTitleTranslated']; ?>
</h2>
<?php else: ?> <h2><?php echo 'Home'; ?>
</h2> <?php endif; ?>
