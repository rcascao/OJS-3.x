<?php /* Smarty version 2.6.26, created on 2014-04-18 22:02:35
...
?>
	...
	<div id="member"><a href="javascript:openRTWindow('<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialTeamBio','path' => $this->_tpl_vars['user']->getId()), $this);?>
