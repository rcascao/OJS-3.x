<?php return array (
  'plugins.paymethod.paypal.displayName' => 'Plugin de Pagamento via Paypal',
  ...
  'plugins.paymethod.paypal.description' => 'O Plugin PayPal permite a usuários, sendo ou não membros do PayPal, utilizar a maioria dos cartões de crédito, bem como Cheques Eletrônicos (eChecks). O responsável deve criar uma <a href="http://www.paypal.com" target="_new">Conta de Negócios PayPal</a>.',
  'plugins.paymethod.paypal.warning' => 'Clique em "Continuar" para acessar o portal do PayPal. Após realizar o pagamento através do PayPal clique em "Retornar ao vendedor" ("Return to Merchant") para retornar ao site de onde iniciou a compra.',
